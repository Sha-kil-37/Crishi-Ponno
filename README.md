...
আমি আমার কৃষি পণ্য এপ্লিকেশনে একটি পেজ তৈরি করতে চাই যেখানে আমার সকল ক্যাটাগরি গুলো কার্ড আকারে প্রদর্শিত হবে এবং প্রতিটি কার্ডের ক্যাটাগরির আন্ডারে কতগুলো প্রোডাক্ট আছে তা প্রদর্শিত হবে এবং যখন আমি ক্যাটাগরি কার্ডে ক্লিক করব তখন ক্যাটাগরি ডিটেলস পেজে নিয়ে যাবে  কিভাবে এটি আমি করতে পারি | এবং আমি এটি ডায়নামিক এপিআই ব্যবহার করে করতে চাই তুমি আমাকে একটি prompt লিখে দাও যা আমি ভিজুয়াল স্টুডিও code এডিটরের কোডিং এ আই github copailot এ prompt আকারে ব্যবহার করে এটি আমি করতে পারি 